...
input_data = ( id_report, id_result, name_vul, host, port, type_verification, nvt, family, str(threat), str(severity), str(description), tags, solution_type, solution)
cur.execute(sql_update_query, input_data)
conn.commit()
...
for record7 in record6:
                                                                ...
                                                                INTO
                                                                `openvas_ref`(`id_ref_DB`, `id_result`, `ref`)
                                                                VALUES(NULL,%s,%s)"""
